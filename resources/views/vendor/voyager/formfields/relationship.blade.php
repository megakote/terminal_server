    ...
    @elseif($options->type == 'hasMany')
      ...
      @if(isset($view) && ($view == 'browse' || $view == 'read'))
        ...
        @php
          ...
          if (View::exists('vendor/voyager/formfields/Models/'. $model_name ) && $view != 'browse') {
            $selected_values = $model::where($options->column, '=', $relationshipData->id)->get();
          } else {
        ...
        @endphp
              ...
              @else
                @if(empty($selected_values))
                  <p>No results</p>
                @else
                  @if(View::exists('vendor/voyager/formfields/Models/'. $model_name ))
                    @include('vendor/voyager/formfields/Models/'. $model_name )
                  @else
                    <ul>
